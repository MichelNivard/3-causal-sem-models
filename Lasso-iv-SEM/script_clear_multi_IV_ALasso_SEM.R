...
y1 <- runif(1,.1,.2)*x[,1] + runif(1,.1,.2)*x[,2] + runif(1,.1,.2)*x[,3] + rnorm(n) 
y2 <- runif(1,.1,.2)*x[,4] + runif(1,.1,.2)*x[,5] + runif(1,.1,.2)*x[,6] + rnorm(n)
...
vioplot(paths,ylim=c(min(b)-.1,max(b)+.1))
