...
- structural equation modeling, or SEM (here is a [youtube](https://www.youtube.com/watch?v=fGdsiugwO0k&list=PLliBbGBc5nn3m8bXQ4CmOep3UmQ_5tVlC) course, here is an online [book]([https://bookdown.org/jdholster1/idsr/structural-equation-modeling.html) walking trough SEM basics in R](https://bookdown.org/njenk001/discovering_structural_equation_modeling_using_stata/) to refresh or learn) 
