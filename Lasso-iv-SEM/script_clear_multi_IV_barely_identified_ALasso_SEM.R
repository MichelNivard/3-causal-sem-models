...
for(i in 1:rep){
  ...
  y1 <- runif(1,.1,.2)*x[,1] + runif(1,.1,.2)*x[,2] + runif(1,.1,.2)*x[,3] + runif(1,.1,.2)*x[,5] + runif(1,.1,.2)*x[,10] + runif(1,.1,.2)*x[,15] + rnorm(n) 
  y2 <- runif(1,.1,.2)*x[,4] + runif(1,.1,.2)*x[,5] + runif(1,.1,.2)*x[,6] + runif(1,.1,.2)*x[,3] + runif(1,.1,.2)*x[,9]  + runif(1,.1,.2)*x[,12] +  rnorm(n)
  y3 <- runif(1,.1,.2)*x[,7] + runif(1,.1,.2)*x[,8] + runif(1,.1,.2)*x[,9] + runif(1,.1,.2)*x[,4] + runif(1,.1,.2)*x[,6]  + runif(1,.1,.2)*x[,13] +  rnorm(n) 
  y4 <- runif(1,.1,.2)*x[,10] + runif(1,.1,.2)*x[,11] + runif(1,.1,.2)*x[,12] + runif(1,.1,.2)*x[,2] + runif(1,.1,.2)*x[,7]  + runif(1,.1,.2)*x[,14]  +rnorm(n)
  y5 <- runif(1,.1,.2)*x[,13] + runif(1,.1,.2)*x[,14] + runif(1,.1,.2)*x[,15] + runif(1,.1,.2)*x[,1] + runif(1,.1,.2)*x[,8] + runif(1,.1,.2)*x[,11] + rnorm(n) 
